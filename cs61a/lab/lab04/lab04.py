...
def distance(city_a, city_b):
    ...
    x = city_a_lat - city_b_lat
    y = city_a_lon - city_b_lon
...
def closer_city(lat, lon, city_a, city_b):
    ...
    a = distance(destination_city, city_a)
    b = distance(destination_city, city_b)

    return get_name(city_a) if a < b else get_name(city_b)
