...
def riffle(deck):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [deck[(x // 2) if x % 2 == 0 else (len(deck) // 2) + (x - 1) // 2] for x in range(len(deck))]
...
def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        for branch in branches(t):
            if berry_finder(branch):      # the idea from "PKU"
                return True
    return False
...
def add_trees(t1, t2):
    ...
    """From PUK"""
    """This problem is difficult, difficult to understand"""
